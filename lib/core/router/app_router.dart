...
import 'package:jaylin_wedding/features/accommodation/accommodation_page.dart';
...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/accommodation', name: 'accommodation', builder: (context, state) => AccommodationPage()),
    // GoRoute(
    //   path: '/details/:id',
    //   name: 'details',
